...
export const setSafeTransferFrom = (contract, account, adFrom,adTo, tokenId)=>{
    return contract.methods.safeTransferFrom(adFrom,adTo,tokenId).estimateGas({from: account});
}

export const setTransferFrom = (contract, account, adFrom,adTo, tokenId)=>{
    return contract.methods.transferFrom(adFrom,adTo,tokenId).estimateGas({from: account});
}